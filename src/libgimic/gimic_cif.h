...
#define gimic_calc_modj FC_FUNC_(gimic_calc_modj, GIMIC_CALC_MODJ)
#define gimic_calc_anapole FC_FUNC_(gimic_calc_anapole, GIMIC_CALC_ANAPOLE)
...
extern "C" {
    ...
    void gimic_calc_anapole(const double *, double *); 
}
