...
# The appropriate #define lines are stored in the cached variables DEFINE_FC_FUNC and
# DEFINE_FC_FUNC_, respectively, and can be used to generate a configuration header
...
IF(SCHEME_NO_UNDERSCORES)
    ...
    IF(SCHEME_NO_UNDERSCORES MATCHES "mysub")
        SET(CPP_macro "#define FC_FUNC(name,NAME) name")
...
IF(SCHEME_WITH_UNDERSCORES)
    ...
    IF(SCHEME_WITH_UNDERSCORES MATCHES "my_sub")
        SET(CPP_macro "#define FC_FUNC_(name,NAME) name")
